...
License  : GPL-1
Requires: perl-Number-Compare-man

%description
No detailed description available

%package man
Summary: man components for the perl-Number-Compare package.
Group: Default

%description man
man components for the perl-Number-Compare package.
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/Number/Compare.pm
